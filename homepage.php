<!--banner-slider-->
  ...
  <section class="w3l-main-slider" id="home">
    <div class="banner-content">
      <div id="demo-1"
        data-zs-src='["<?php echo base_url();?>/<?php echo base_url();?>/assets/images/banner1.jpg", "<?php echo base_url();?>/assets/images/banner2.jpg","assets/images/banner3.jpg", "<?php echo base_url();?>/assets/images/banner4.jpg"]'
